...
function(aws_use_package_private package_name)
    if (IN_SOURCE_BUILD)
        set(DEP_AWS_LIBS ${DEP_AWS_LIBS_PRIVATE} ${package_name} PARENT_SCOPE)
    else()
        find_package(${package_name} REQUIRED)
        set(DEP_AWS_LIBS ${DEP_AWS_LIBS_PRIVATE} AWS::${package_name} PARENT_SCOPE)
    endif()
endfunction()
