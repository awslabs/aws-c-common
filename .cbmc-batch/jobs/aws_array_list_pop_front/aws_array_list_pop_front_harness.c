...
/**
 * Coverage: 1.00 (129 lines out of 129 statically-reachable lines in 19 functions reached)
 * Runtime: 0m7.093s
 *
 * Assumptions:
 ...
 *     - aws_array_list_pop_front == AWS_OP_SUCCESS
 *                                 -> list->length == previous length - 1
 *     - aws_array_list_pop_front == AWS_OP_ERR
