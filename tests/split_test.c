...
AWS_TEST_CASE(test_byte_cursor_next_split_multi, s_test_byte_cursor_next_split_multi)
static int s_test_byte_cursor_next_split_multi(struct aws_allocator *allocator, void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    ASSERT_INT_EQUALS(aws_last_error(), err);
