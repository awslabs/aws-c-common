...
static int s_array_list_order_push_back_pop_front_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_SUCCESS(
        ...
        aws_last_error());
    ASSERTF_INT_EQUALS(0, list.length, "List size should be 0.");
    ASSERTF_INT_EQUALS(
    ...
    ASSERTF_INT_EQUALS(list_size, list.length, "List size should be %d.", (int)list_size);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(aws_array_list_pop_front(&list), "List pop front failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(first, item, "Item should have been the first item.");
    ASSERTF_INT_EQUALS(list_size - 1, list.length, "List size should be %d.", (int)list_size - 1);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(
        aws_array_list_front(&list, (void *)&item), "List front failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_pop_front(&list), "List pop front failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(second, item, "Item should have been the second item.");
    ASSERTF_INT_EQUALS(list_size - 2, list.length, "List size should be %d.", (int)list_size - 2);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(
        aws_array_list_front(&list, (void *)&item), "List front failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_pop_front(&list), "List pop front failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(third, item, "Item should have been the third item.");
    ASSERTF_INT_EQUALS(list_size - 3, list.length, "List size should be %d.", (int)list_size - 3);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(
        aws_array_list_front(&list, (void *)&item), "List front failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_pop_front(&list), "List pop front failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(fourth, item, "Item should have been the fourth item.");
    ASSERTF_INT_EQUALS(list_size - 4, list.length, "List size should be %d.", (int)list_size - 4);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
...
static int s_array_list_order_push_back_pop_back_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    int item = 0;
    ASSERTF_SUCCESS(aws_array_list_back(&list, (void *)&item), "List back failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_pop_back(&list), "List pop back failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(fourth, item, "Item should have been the fourth item.");
    ASSERTF_INT_EQUALS(list_size - 1, list.length, "List size should be %d.", (int)list_size - 4);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(aws_array_list_pop_back(&list), "List pop back failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(third, item, "Item should have been the third item.");
    ASSERTF_INT_EQUALS(list_size - 2, list.length, "List size should be %d.", (int)list_size - 3);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(aws_array_list_pop_back(&list), "List pop back failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(second, item, "Item should have been the second item.");
    ASSERTF_INT_EQUALS(list_size - 3, list.length, "List size should be %d.", (int)list_size - 2);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
    ...
    ASSERTF_SUCCESS(aws_array_list_pop_back(&list), "List pop back failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(first, item, "Item should have been the first item.");
    ASSERTF_INT_EQUALS(list_size - 4, list.length, "List size should be %d.", (int)list_size - 1);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "Allocated list size should be %d.", (int)list_size * sizeof(int));
...
static int s_array_list_pop_front_n_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    aws_array_list_pop_front_n(&list, 2);
    ASSERTF_INT_EQUALS(0, aws_array_list_length(&list), "List should be empty after popping last 2 items");
...
static int s_array_list_exponential_mem_model_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_INT_EQUALS(list_size, list.current_size / sizeof(int));
    ...
    ASSERTF_INT_EQUALS(3, list.length, "List size should be %d.", 3);
...
static int s_array_list_iteration_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_INT_EQUALS(1, list.length, "List size should be %d.", 1);
    ASSERTF_SUCCESS(
        aws_array_list_set_at(&list, (void *)&second, 1), "Array set failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(2, list.length, "List size should be %d.", 2);
    ASSERTF_SUCCESS(
    ...
    ASSERTF_INT_EQUALS(4, list.length, "List size should be %d.", 4);
...
static int s_array_list_preallocated_iteration_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_SUCCESS(
        aws_array_list_set_at(&list, (void *)&fourth, 3), "Array set failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(4, list.length, "List size should be %d.", 4);
    ASSERTF_FAILS(aws_array_list_set_at(&list, (void *)&fourth, 4), "Adding element past the end should have failed");
    ASSERTF_INT_EQUALS(
    ...
    ASSERTF_SUCCESS(
        aws_array_list_get_at(&list, (void *)&item, 3), "Array set failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(fourth, item, "Item should have been the fourth item.");
    ASSERTF_FAILS(aws_array_list_get_at(&list, (void *)&item, 4), "Getting an element past the end should have failed");
    ASSERTF_INT_EQUALS(
        AWS_ERROR_INVALID_INDEX,
        aws_last_error(),
        "Error code should have been INVALID_INDEX but was %d",
...
static int s_array_list_preallocated_push_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_INT_EQUALS(0, list.length, "List size should be 0.");
    ASSERTF_INT_EQUALS(sizeof(list_data), list.current_size, "Allocated list size should be %d.", sizeof(list_data));

    ASSERTF_SUCCESS(aws_array_list_push_back(&list, &first), "List push failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_push_back(&list, &second), "List push failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_push_back(&list, &third), "List push failed with error code %d", aws_last_error());
    ASSERTF_SUCCESS(aws_array_list_push_back(&list, &fourth), "List push failed with error code %d", aws_last_error());
    ASSERTF_ERROR(
...
static int s_array_list_shrink_to_fit_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_INT_EQUALS(2, list.length, "List size should be %d.", 2);
    ASSERTF_INT_EQUALS(2, list.current_size / sizeof(int), "Shrunken size should be %d.", 2 * sizeof(int));

    int item = 0;
    ASSERTF_SUCCESS(aws_array_list_get_at(&list, &item, 0), "Array set failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(first, item, "Item should have been the first item.");
    ASSERTF_SUCCESS(aws_array_list_get_at(&list, &item, 1), "Array set failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(second, item, "Item should have been the second item.");
    ASSERTF_FAILS(aws_array_list_get_at(&list, &item, 2), "Getting an element past the end should have failed");
    ASSERTF_INT_EQUALS(
        AWS_ERROR_INVALID_INDEX,
        aws_last_error(),
        "Error code should have been INVALID_INDEX but was %d",
...
static int s_array_list_shrink_to_fit_static_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_INT_EQUALS(sizeof(list_data), list.current_size, "size before shrink should be %d.", sizeof(list_data));

    ASSERTF_FAILS(aws_array_list_shrink_to_fit(&list), "List shrink of static list should have failed.");
    ASSERTF_INT_EQUALS(
    ...
    ASSERTF_PTR_EQUALS(&list_data, list.data, "The underlying allocation should not have changed");
    ASSERTF_INT_EQUALS(sizeof(list_data), list.current_size, "List size should not have been changed");
...
static int s_array_list_clear_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    aws_array_list_clear(&list);
    ASSERTF_INT_EQUALS(0, list.length, "List size should be %d after clear.", 0);
    ASSERTF_INT_EQUALS(
        list_size, list.current_size / sizeof(int), "cleared size should be %d.", (int)list_size * sizeof(int));

    int item;
    ASSERTF_FAILS(
        aws_array_list_front(&list, (void *)&item), "front() after a clear on list should have been an error");
    ASSERTF_INT_EQUALS(
...
static int s_array_list_copy_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_INT_EQUALS(1, list_a.length, "List size should be %d.", 1);
    ASSERTF_SUCCESS(
        aws_array_list_push_back(&list_a, (void *)&second), "List push failed with error code %d", aws_last_error());
    ASSERTF_INT_EQUALS(2, list_a.length, "List size should be %d.", 2);

    ASSERTF_SUCCESS(aws_array_list_copy(&list_a, &list_b), "List copy failed with error code %d", aws_last_error());
...
static int s_array_list_swap_contents_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_PTR_EQUALS(
        b_buffer, a_buffer_after_swap, "Lists A and B should have swapped buffer ownership, but did not");

    void *b_buffer_after_swap;
    ASSERT_SUCCESS(aws_array_list_get_at_ptr(&list_b, &b_buffer_after_swap, 0));
    ASSERTF_PTR_EQUALS(
        a_buffer, b_buffer_after_swap, "Lists A and B should have swapped buffer ownership, but did not");

    int item;
    ASSERTF_INT_EQUALS(2, aws_array_list_length(&list_a), "List A should have taken B's old length");
    ASSERTF_INT_EQUALS(b_capacity, aws_array_list_capacity(&list_a), "List A should have taken B's old capacity");
    ASSERTF_SUCCESS(aws_array_list_get_at(&list_a, &item, 0), "List A should have B's old first item");
    ASSERTF_INT_EQUALS(b_1, item, "List A should have B's old first item");
    ASSERTF_SUCCESS(aws_array_list_get_at(&list_a, &item, 1), "List A should have B's old second item");
    ASSERTF_INT_EQUALS(b_2, item, "List A should have B's old second item");

    ASSERTF_INT_EQUALS(1, aws_array_list_length(&list_b), "List B should have taken A's old length");
    ASSERTF_INT_EQUALS(a_capacity, aws_array_list_capacity(&list_b), "List B should have taken A's old capacity");
    ASSERTF_SUCCESS(aws_array_list_get_at(&list_b, &item, 0), "List B should have A's old first item");
    ASSERTF_INT_EQUALS(a_1, item, "List B should have A's old first item");
...
static int s_array_list_not_enough_space_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_SUCCESS(aws_array_list_copy(&list_a, &list_b), "Copy from list_a to list_b should have succeeded");
    ASSERTF_INT_EQUALS(list_a.length, list_b.length, "List b should have grown to the length of list a");
    ASSERTF_INT_EQUALS(
        2 * sizeof(int),
        list_b.current_size,
...
static int s_array_list_of_strings_sort_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    for (int idx = 0; idx < num_strings; ++idx) {
        ...
        ASSERTF_INT_EQUALS(0, aws_string_compare(str, sorted[idx]), "Strings should be equal");
    }
    aws_array_list_clean_up(&list);
    return 0;
}
