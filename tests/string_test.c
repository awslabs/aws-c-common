...
static int test_str_split_happy_path_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "testa\r\ntestb\r\ntestc";
    ...
    struct aws_array_list output;
    ASSERT_SUCCESS(aws_array_list_init_dynamic(&output, allocator, 4, sizeof(struct aws_byte_buf)), "Array list init failed!");
    ASSERT_SUCCESS(aws_string_split_on_str(&to_split, "\r\n", &output), "String split failed");
    ASSERT_INT_EQUALS(3, aws_array_list_length(&output), "Split should have returned %d elements", 3);
...
AWS_TEST_CASE(test_str_split_happy_path, test_str_split_happy_path_fn)

static int test_str_split_ends_with_token_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "testa\r\ntestb\r\ntestc\r\n";
...
AWS_TEST_CASE(test_str_split_ends_with_token, test_str_split_ends_with_token_fn)


static int test_str_split_token_not_present_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "testa";
...
AWS_TEST_CASE(test_str_split_token_not_present, test_str_split_token_not_present_fn)

static int test_str_split_empty_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "";
...
AWS_TEST_CASE(test_str_split_empty, test_str_split_empty_fn)

static int test_str_split_partial_token_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "testa\r\rtestb\r\ntestc";
    ...
    ASSERT_SUCCESS(aws_array_list_init_dynamic(&output, allocator, 4, sizeof(struct aws_byte_buf)), "Array list init failed!");
    ASSERT_SUCCESS(aws_string_split_on_str(&to_split, "\r\n", &output), "String split failed");
    ASSERT_INT_EQUALS(2, aws_array_list_length(&output), "Split should have returned %d elements", 2);

    struct aws_byte_buf value = {0};
    ASSERT_SUCCESS(aws_array_list_get_at(&output, &value, 0), "Retrieving element at 0 failed.");

    char *expected = "testa\r\rtestb";
...
AWS_TEST_CASE(test_str_split_partial_token, test_str_split_partial_token_fn)

static int test_str_split_adj_tokens_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "testa\r\n\r\ntestb\r\ntestc";
...
AWS_TEST_CASE(test_str_split_adj_tokens, test_str_split_adj_tokens_fn)

static int test_str_split_begins_with_token_fn(struct aws_allocator *allocator, void *ctx) {
    const char str_to_split[] = "\r\ntesta\r\ntestb\r\ntestc";
...
AWS_TEST_CASE(test_str_split_begins_with_token, test_str_split_begins_with_token_fn)
