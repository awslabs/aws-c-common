...
static int s_string_tests_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_NULL(test_string_1->allocator, "Static string should have no allocator.");
    ASSERTF_INT_EQUALS(test_string_1->len, 8, "Length should have been set correctly.");
    ...
    ASSERTF_NOT_NULL(test_string_2, "Memory allocation of string should have succeeded.");
    ASSERTF_PTR_EQUALS(test_string_2->allocator, allocator, "Allocator should have been set correctly.");
    ASSERTF_INT_EQUALS(test_string_2->len, 8, "Length should have been set correctly.");
    ASSERTF_BIN_ARRAYS_EQUALS(
    ...
    ASSERTF_TRUE(aws_string_eq(test_string_1, test_string_2), "Buffers should be equal.");
    ASSERTF_INT_EQUALS(
    ...
    ASSERTF_INT_EQUALS(short_dest_buf.len, 0, "Destination cursor length should be unchanged.");
    ASSERTF_INT_EQUALS(0, short_dest_buf.buffer[0], "Destination cursor should not have received data.");
    ...
    ASSERTF_NOT_NULL(dup_string_1, "Memory allocation of string should have succeeded.");
    ASSERTF_TRUE(aws_string_eq(test_string_1, dup_string_1), "Strings should be equal.");

    struct aws_string *dup_string_2 = aws_string_new_from_string(allocator, test_string_2);
    ASSERTF_NOT_NULL(dup_string_2, "Memory allocation of string should have succeeded.");
    ASSERTF_TRUE(aws_string_eq(test_string_2, dup_string_2), "Strings should be equal.");
    ...
    ASSERTF_NOT_NULL(clone_string_1, "Memory allocation of string should have succeeded.");
    ASSERTF_TRUE(aws_string_eq(test_string_1, clone_string_1), "Strings should be equal.");
    ASSERTF_TRUE(test_string_1 == clone_string_1, "Static strings should be reused");

    struct aws_string *clone_string_2 = aws_string_clone_or_reuse(allocator, test_string_2);
    ASSERTF_NOT_NULL(clone_string_2, "Memory allocation of string should have succeeded.");
    ASSERTF_TRUE(aws_string_eq(test_string_2, clone_string_2), "Strings should be equal.");
    ASSERTF_TRUE(test_string_2 != clone_string_2, "Dynamic strings should not be reused");
...
static int s_binary_string_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_NOT_NULL(binary_string, "Memory allocation of string should have succeeded.");
    ASSERTF_PTR_EQUALS(allocator, binary_string->allocator, "Allocator should have been set correctly.");
    ASSERTF_BIN_ARRAYS_EQUALS(
        test_array,
        len,
...
static int string_destroy_secure_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERTF_NOT_NULL(empty, "Memory allocation of string should have succeeded.");
    ASSERTF_NOT_NULL(logorrhea, "Memory allocation of string should have succeeded.");
    ASSERTF_NOT_NULL(deadbeef, "Memory allocation of string should have succeeded.");
