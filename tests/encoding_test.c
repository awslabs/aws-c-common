...
static int run_hex_encoding_test_case(
    ...
    ASSERT_INT_EQUALS(
        expected_size,
        output_size,
        "Output size on string should be %d",
        expected_size);

    struct aws_byte_buf to_encode =
        aws_byte_buf_from_array((const uint8_t *)test_str, test_str_size - 1);
    ...
    struct aws_byte_buf output =
        aws_byte_buf_from_array(allocation.buffer + 1, output_size);
    output.len = 0;
    ...
    struct aws_byte_buf expected_buf =
        aws_byte_buf_from_array((const uint8_t *)expected, expected_size - 1);
    ASSERT_SUCCESS(
        aws_hex_decode(&expected_buf, &output),
        "decode call should have succeeded");
    ...
    ASSERT_BIN_ARRAYS_EQUALS(
        ...
        output.buffer,
        output_size,
        "Decode output should have been %s.",
        test_str);
    ASSERT_INT_EQUALS(output_size, output.len);
    ASSERT_INT_EQUALS(
        (unsigned char)*(allocation.buffer),
...
static int hex_encoding_test_case_empty(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
    ...
    return run_hex_encoding_test_case(
        allocator, test_data, sizeof(test_data), expected, sizeof(expected));
}

AWS_TEST_CASE(hex_encoding_test_case_empty_test, hex_encoding_test_case_empty)

static int hex_encoding_test_case_f(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int hex_encoding_test_case_fo(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int hex_encoding_test_case_foo(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int hex_encoding_test_case_foob(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int hex_encoding_test_case_fooba(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int hex_encoding_test_case_foobar(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int hex_encoding_test_case_missing_leading_zero_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    struct aws_byte_buf output_buf =
        aws_byte_buf_from_array(output, sizeof(expected));
    ...
    ASSERT_BIN_ARRAYS_EQUALS(
        ...
        output,
        sizeof(output),
        "Hex decode expected output did not match actual output");
...
AWS_TEST_CASE(
    ...
    hex_encoding_test_case_missing_leading_zero_fn)

static int hex_encoding_invalid_buffer_size_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    struct aws_byte_buf test_buf = aws_byte_buf_from_c_str(test_data);
    struct aws_byte_buf output_buf =
        aws_byte_buf_from_array(output, size_too_small);
...
AWS_TEST_CASE(
    ...
    hex_encoding_invalid_buffer_size_test_fn)

static int hex_encoding_overflow_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    struct aws_byte_buf test_buf =
        aws_byte_buf_from_array((const uint8_t *)test_data, overflow);
    struct aws_byte_buf output_buf =
...
static int hex_encoding_invalid_string_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    hex_encoding_invalid_string_test_fn)
...
static int run_base64_encoding_test_case(
    ...
    struct aws_byte_buf to_encode =
        aws_byte_buf_from_array((const uint8_t *)test_str, test_str_size);
    struct aws_byte_buf allocation;
    ASSERT_SUCCESS(aws_byte_buf_init(allocator, &allocation, output_size + 2));
    memset(allocation.buffer, 0xdd, allocation.capacity);
    ...
    ASSERT_SUCCESS(
        aws_base64_compute_decoded_len(
            expected, expected_size - 1, &output_size),
    ...
    struct aws_byte_buf expected_buf =
        aws_byte_buf_from_array((const uint8_t *)expected, expected_size - 1);
    ASSERT_SUCCESS(
        aws_base64_decode(&expected_buf, &output),
        "decode call should have succeeded");
...
static int base64_encoding_test_case_empty(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
    ...
    return run_base64_encoding_test_case(
        allocator,
        test_data,
        sizeof(test_data) - 1,
        expected,
...
AWS_TEST_CASE(
    ...
    base64_encoding_test_case_empty)

static int base64_encoding_test_case_f(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int base64_encoding_test_case_fo(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int base64_encoding_test_case_foo(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int base64_encoding_test_case_foob(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_test_case_foob)

static int base64_encoding_test_case_fooba(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_test_case_fooba)

static int base64_encoding_test_case_foobar(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_test_case_foobar)

static int base64_encoding_test_zeros_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
 ...
 */
static int base64_encoding_test_all_values_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_test_all_values_fn)

static int base64_encoding_buffer_size_too_small_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_buffer_size_too_small_test_fn)

static int base64_encoding_buffer_size_overflow_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    struct aws_byte_buf test_buf =
        aws_byte_buf_from_array((const uint8_t *)test_data, overflow + 2);
    struct aws_byte_buf output_buf =
        aws_byte_buf_from_array(output, sizeof(output));
    ...
    struct aws_byte_buf encoded_buf =
        aws_byte_buf_from_array((const uint8_t *)encoded_data, overflow);
...
AWS_TEST_CASE(
    ...
    base64_encoding_buffer_size_overflow_test_fn)

static int base64_encoding_buffer_size_invalid_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    struct aws_byte_buf encoded_buf = aws_byte_buf_from_array(
        (const uint8_t *)encoded_data, sizeof(encoded_data));
    struct aws_byte_buf output_buf =
        aws_byte_buf_from_array(output, sizeof(output));
...
AWS_TEST_CASE(
    ...
    base64_encoding_buffer_size_invalid_test_fn)

static int base64_encoding_invalid_buffer_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_invalid_buffer_test_fn)

static int base64_encoding_invalid_padding_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    base64_encoding_invalid_padding_test_fn)
...
static int uint64_buffer_test_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    ASSERT_BIN_ARRAYS_EQUALS(
        ...
        buffer,
        sizeof(buffer),
        "Uint64_t to buffer failed");

    uint64_t unmarshalled_value = aws_read_u64(buffer);
    ASSERT_INT_EQUALS(
        test_value,
        unmarshalled_value,
        "After unmarshalling the encoded data, it didn't match");
    return 0;
}

AWS_TEST_CASE(uint64_buffer_test, uint64_buffer_test_fn)

static int uint64_buffer_non_aligned_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
    ...
    ASSERT_FALSE(
        (size_t)buffer & 0x07,
        "Heap allocated buffer should have been 8-byte aligned.");
...
static int uint32_buffer_non_aligned_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int uint24_buffer_non_aligned_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int uint16_buffer_non_aligned_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)ctx;
...
static int uint16_buffer_signed_positive_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    uint16_buffer_signed_positive_test_fn)

static int uint16_buffer_signed_negative_test_fn(
    struct aws_allocator *allocator,
    void *ctx) {
    (void)allocator;
    (void)ctx;
...
AWS_TEST_CASE(
    ...
    uint16_buffer_signed_negative_test_fn)
