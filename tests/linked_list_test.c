...
static int test_linked_list_reverse_iteration(struct aws_allocator *allocator, void *ctx) {
    struct aws_linked_list list;
...
AWS_TEST_CASE(linked_list_reverse_iteration, test_linked_list_reverse_iteration)
