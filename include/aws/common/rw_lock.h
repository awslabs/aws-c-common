 ...
 */
inline int aws_rw_lock_init(struct aws_rw_lock *lock);

/**
 * Cleans up internal resources.
 */
inline void aws_rw_lock_clean_up(struct aws_rw_lock *lock);
 ...
 */
inline int aws_rw_lock_rlock(struct aws_rw_lock *lock);
inline int aws_rw_lock_wlock(struct aws_rw_lock *lock);
 ...
 * you should not treat it like one. On platforms it is possible for it to be non-reentrant, it will be.
*/
inline int aws_rw_lock_try_rlock(struct aws_rw_lock *lock);
inline int aws_rw_lock_try_wlock(struct aws_rw_lock *lock);

/**
 * Releases the lock.
 */
inline int aws_rw_lock_runlock(struct aws_rw_lock *lock);
inline int aws_rw_lock_wunlock(struct aws_rw_lock *lock);
