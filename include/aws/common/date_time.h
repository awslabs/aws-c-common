...
enum aws_date_month {
    ...
    AWS_DATE_MONTH_MAY,
    AWS_DATE_MONTH_JUNE,
    /* ABI-BREAK TEST #8 (insert enum value mid-sequence): every enumerator
     * after this point silently shifts its integer value; callers compiled
     * against the old enum compare against the wrong constant. */
    AWS_DATE_MONTH_MIDYEAR_MARKER,
    AWS_DATE_MONTH_JULY,
