...
### CMake Options
* -DCMAKE_CLANG_TIDY=/path/to/clang-tidy (or just clang-tidy or clang-tidy-7.0 if it is in your PATH)
* -DENABLE_SANITIZERS=ON - Enables gcc/clang sanitizers, by default 'address' and 'undefined'
