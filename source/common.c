...
static struct aws_error_info errors[] = {
        ...
        AWS_DEFINE_ERROR_INFO(aws_error_list_static_mode_cant_shrink, AWS_ERROR_LIST_STATIC_ILLEGAL_SIZE, "attempt to use static list mode with an array_size that isn't a multiple of item_size", AWS_LIB_NAME),
};
