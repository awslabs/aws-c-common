 ...
 */
_CBOR_NODISCARD cbor_item_t *cbor_tag_item(const cbor_item_t *tag);
 ...
 */
_CBOR_NODISCARD uint64_t cbor_tag_value(const cbor_item_t *tag);
 ...
 * @return `NULL` if memory allocation fails.
 */
_CBOR_NODISCARD cbor_item_t *cbor_build_tag(uint64_t value,
                                                        cbor_item_t *item);
