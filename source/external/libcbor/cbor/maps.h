 ...
 */
_CBOR_NODISCARD bool cbor_map_add(cbor_item_t *item,
 ...
 */
_CBOR_NODISCARD bool _cbor_map_add_key(cbor_item_t *item,
                                                   cbor_item_t *key);
 ...
 * preallocated storage is full
 */
_CBOR_NODISCARD bool _cbor_map_add_value(cbor_item_t *item,
                                                     cbor_item_t *value);
 ...
 */
_CBOR_NODISCARD bool cbor_map_is_indefinite(
 ...
 */
_CBOR_NODISCARD struct cbor_pair *cbor_map_handle(
    const cbor_item_t *item);
