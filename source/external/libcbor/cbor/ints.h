 ...
 */
_CBOR_NODISCARD uint64_t cbor_get_int(const cbor_item_t *item);
 ...
 *  @return the width
 */
_CBOR_NODISCARD cbor_int_width
 ...
 */
_CBOR_NODISCARD cbor_item_t *cbor_build_negint8(uint8_t value);
 ...
 * @return **new** negative integer or `NULL` on memory allocation failure
 */
_CBOR_NODISCARD cbor_item_t *cbor_build_negint16(uint16_t value);
 ...
 * @return **new** negative integer or `NULL` on memory allocation failure
 */
_CBOR_NODISCARD cbor_item_t *cbor_build_negint32(uint32_t value);
 ...
 * @return **new** negative integer or `NULL` on memory allocation failure
 */
_CBOR_NODISCARD cbor_item_t *cbor_build_negint64(uint64_t value);
